...
public class Account {
    ...
    static Account createNewRandom() {
        ...
        // String accNumNoCheck = "400000" + String.format("%09d", (long) (Math.random() * 999999999L)) + "1";
        String accNumNoCheck = "400000" + String.format("%09d", (long) (Math.random() * 999999999L));
        a.setCardNumber(accNumNoCheck);
        a.setCardNumber(accNumNoCheck + generateLuhn(accNumNoCheck));
    ...
    private static int generateLuhn (String number){
        return 0;
    }
}